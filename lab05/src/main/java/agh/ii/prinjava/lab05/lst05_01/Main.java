...
public class Main {
    ...
    private static void listMods(List<Integer> lst) {
        ...
        lst.add(1, -20);//add==> replace the index on the list by the element
        lst.set(2, -30);
        System.out.println("l1.set = " + lst);//set==> adds the element to the list, by taking the place of the index

        lst.remove(1);==> //remove the element of the index
        lst.remove(Integer.valueOf(-30));
        System.out.println("l1.remove = " + lst);
    }
    ...
    private static void demo1() {
        ...
        System.out.println("array ints = " + Arrays.toString(ints)); // <-- Need the method to String
    ...
    private static void demo4() {
        ...
        l1.add(50);//==> adds at last rank if no index is given
        l1.addFirst(0);//==> adds at first place and doesn't remove the first one if no index is given
        l1.addLast(60);//==>adds at last place and doesn't remove the last one if no index is given
        System.out.println("l1 = " + l1);
